...
class NextMatchFragmentTest {
    ...
    fun testRecyclerViewBehaviour() {
        Espresso.onView(ViewMatchers.withId(R.id.pbNextEvent))
                .check(ViewAssertions.matches(ViewMatchers.isDisplayed()))
        Espresso.onView(ViewMatchers.withId(R.id.pbNextEvent)).perform(RecyclerViewActions.scrollToPosition<RecyclerView.ViewHolder>(10))
        Espresso.onView(ViewMatchers.withId(R.id.pbNextEvent)).perform(
